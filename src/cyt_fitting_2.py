...
for harmonic in range(3, 7):
    ...
    values=[[-0.0472052292762673, 0.4386942444873024, 452.0102685957383, 240.16633431888823, 0.001473390543042464, -0.04999735919925375, 0.004248352116159064, 1.9408285365873813e-10, 8.941017911047922, 3.4041753467260043, 3.1481603935186966, 0.40010922751911393]]
    values=[[-0.17672094507705438, 0.010000000000110202, 699.2450071284973, 999.999999999997, 0.0006167394011408204, 0.14999999999827981, 0.008862853766546731, 8.385268167876837e-11, 8.941027143737715, 1.6250912194600746, 4.093924295014967, 0.5999999999999546]]
    values=[[-0.3679765, 0.17815241678259613, 9999.99999986146, 243.4927235729692, 0.0019999999999992723, 0.05716010086615872, 0.00527384220240972, 8.717637462167277e-10, 8.940999723291377, 2.0370371168408243, 3.3792727923117933, 0.599999999999997]]
    cyt.def_optim_list(["E0_mean", "E0_std","k_0","Ru","Cdl","CdlE1", "CdlE2","gamma","omega","cap_phase","phase", "alpha"])
    ...
    v=[-0.0472052292762673, 0.4386942444873024, 452.0102685957383, 240.16633431888823, 0.001473390543042464, -0.04999735919925375, 0.004248352116159064, 1.9408285365873813e-10, 8.941017911047922, 3.4041753467260043, 3.1481603935186966, 0.40010922751911393]
    v=[-0.36797379211384085, 0.15454972600441857, 3117.986938152765, 667.0246521209505, 3.0488279012451747e-05, -0.07802866020430985, 0.0074588923833212705, 2.5131303557781643e-10, 8.941019340890694, 4.458716421616303, 5.395348026784975, 0.46969893748813096]
    ...
    cap=cyt.test_vals([], "timeseries")
    cyt.def_optim_list(["E0_mean", "E0_std","k_0","Ru", "gamma","alpha", "phase"])
    obj_fun=harms.inv_objective_fun(true_signal, time_results[0]-time_results[1])
    current_obj_fun=harms.inv_objective_fun(current_results,time_results[0]-time_results[1])
    plt.plot(time_results, obj_fun)
    plt.plot(time_results, current_obj_fun)
    plt.show()
    #cyt.def_optim_list(["E0_mean", "E0_std","k_0","Ru", "gamma", "alpha", "phase"])
    #cyt.dim_dict["Cdl"]=0
