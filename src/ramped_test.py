...
values=values=[[-0.2120092471414607, 0.0005478233474769771, 116.21497065365581, 431.92918718571053, 0.00044100528598203375, 0.14367030986553458, 0.005163770653874243, 9.999387751676114e-11, 8.881077023434541,0, 0.5997147084901965],\
        [-0.30978826058698744, 0.0011747969813993733, 83.58943751970683, 351.84551152031054, 0.000767528492853802, 0.0828273845158425, 0.0016183047215945039, 9.889421336332628e-11, 8.880528233151985, 0, 0.597523000771728],\
        [-0.2085010348585462, 0.0001769719441256009, 93.88915054231003, 621.7895281614545, 0.00038185721998072834, 0.14858346584854376, 0.005464884000805036, 9.995887932170653e-11, 8.88129543205022, 0, 0.5990602813196874],\
        [-0.18408651864872588, 0.03810377947655846, 37.99182466615228, 206.07566180326032, 0.000917892619282633, 0.14267120449901333, 0.005115346249619759, 9.999947573178033e-10, 8.88051615668972, 0, 0.5971094383283885]
...
for q in range(0, len(values)):
    ...
    vals=[-0.2120092471414607, 0.0005478233474769771, 116.21497065365581, 431.92918718571053, 0.00044100528598203375*0, 0.14367030986553458, 0.005163770653874243, 9.999387751676114e-11, 8.941077023434541,  3.4597619059667073, 0.5997147084901965]
    ...
    for i in range(0, len(data_harmonics)):
        ax[i][q].plot(time_results[quake:-quake], (data_harmonics[i,:][quake:-quake]),  label="Data")
        ax[i][q].plot(time_results[quake:-quake], syn_harmonics[i,:][quake:-quake], alpha=0.7, label="Simulated")
        ax2=ax[i][q].twinx()
        ax2.set_yticks([])
