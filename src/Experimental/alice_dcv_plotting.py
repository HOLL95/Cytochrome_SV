...
PSV_optim_list=["E0_mean", "E0_std","k_0","Ru","Cdl","CdlE1", "CdlE2","CdlE3","gamma","omega","cap_phase","phase", "alpha"]
ramped_optim_list=["E0_mean", "E0_std","k_0","Ru","Cdl","CdlE1", "CdlE2","gamma","omega","phase", "alpha"]
optims=[ramped_optim_list, PSV_optim_list]
vals=[[-0.05744624908677006, 0.02788517403038323, 164.40170561479968, 268.7042102662674, 0.00019999999918567714, -0.01781717221653123, -0.0010262335333251996, 2.4414183646021532e-11, 8.959320552342025, 6.283184732454485, 0.40000000000073965],
        [-0.07963988256472493, 0.043023349442016245, 20.550878790990733, 581.5147052074157, 8.806259570340898e-05, -0.045583168350011485, -0.00011159862236990309, 0.00018619134662841048, 2.9947102043021914e-11, 9.014976375142606, 5.699844468024501, 5.18463541959069, 0.5999994350046962],]
for q in range(1, 3):
    file_name="/dcV_Cjx-183D_WT_pH_7_{0}_3".format(str(q))
    ...
    current_results=cyt.i_nondim(cyt.other_values["experiment_current"])*1e3
    ...
    inferred_params=[vals[q-1][optims[q-1].index(x)] for x in cyt.optim_list]
...
DCV_inferred_2=[-0.049697063448006555, 0.0037230268328498823, 0.3527926751864493, 4.773196671248675e-10, 1.196896571851427e-11, 0.5513930594926286]
DCV_inferred_1=[-0.051002951188454194, 1.0000168463482572e-05, 0.5871952270775241, 3.4006592554802374e-07, 3.107639506959287e-11, 0.4521221354084581]
