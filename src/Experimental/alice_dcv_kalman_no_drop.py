...
[-0.049331574518677736, 5539.115269722919, 137163.27046723323, 4.743291416597627e-05, 9.46629880570902e-12, 0.4586225743421759, 0.0841946717269824]
[-0.04980781697856889, 7896.39758006574, 94104.07094626928, 4.71269235547076e-05, 1.0063551561437658e-11, 0.47812810080708223, 0.08419466766893136]
...
set1=[
    [-0.050408767370443024, 0.09497513747631915, 299.99200900853094, 4.728801367347065e-05, 1.0398640363481766e-11, 0.4992071888510464, 0.0841946716462203],
    [-5.414609871579046e-10, 6927.369657192836, 66.7618881518237, 3.166843361959333e-05, 5.000000043777827e-12, 0.44256509663522103, 0.08206490877019161],
    [-0.05247201375395846, 1869.6865460763302, 32.50515721830168, 2.0463449316375022e-06, 5.00000000341141e-12, 0.5434429487536673, 0.07298348017333445],
    ...
    [-0.04867890494247045, 0.0010094838321794417, 178.09984477733062, 3.385149190321681e-05, 7.306577873461583e-12, 0.40000018901706585, 0.0820210519736999],
    [-0.032852125295313145, 9980.181981188853, 244.46549671072145, 2.2844616560071656e-06, 5.000000000498756e-12, 0.5331933030556149, 0.07170256362092944],
    ...
    [-0.049845293435488484, 0.001000004805802035, 5.209226467393232, 3.1814499689707456e-05, 7.592244875496075e-12, 0.4955705563440733, 0.08206237243857595],
    [-7.951972413877684e-14, 0.0010000000000006369, 299.99944024606293, 2.1213427638469437e-06, 4.999999999997999e-11, 0.4271964757032176, 0.07168908245116024]]
...
for i in range(0, len(k_vals)):
    for j in range(0, len(r_vals)):
        ...
        DCV_inferred=[k_vals[i], r_vals[j], 5e-5, 1e-2, 1e-3, 1e-5, 1e-11, -0.05, 0.5]
        current=cyt.test_vals(DCV_inferred, "timeseries")
        ...
        #cmaes_time=cyt.test_vals(set1[counter-1], likelihood="timeseries", test=False)
        #counter+=1



        #plt.plot(volts, cmaes_time)
        #plt.plot(volts, noisy_current, alpha=0.7)
#plt.show()
