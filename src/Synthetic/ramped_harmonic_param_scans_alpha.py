...
for regime in ["irreversible", "reversible"]:
    ...
    params={"E_0":{"E0_mean":[-0.2, -0.25, -0.3],
                    ...
                    "E0_skew":[-5, 0, 5]},
            "alpha":{"alpha_mean":([0.4, 0.5, 0.6]),
                    "alpha_std":[0.01, 0.05, 0.1]}}
    unit_dict={
        "E_0": "V",
    ...
    plot_locs={"E_0":{"E0_mean":{"row":"row1", "col":0, "col_end":False, "func":e0_re_dim},
            ...
            "alpha":{"alpha_mean":{"row":"row2", "col":1, "col_end":True, "func":empty},
                    "alpha_std":{"row":"row1", "col":1, "col_end":False, "func":empty}}}
