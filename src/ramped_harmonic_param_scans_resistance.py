...
regime="reversible"
for regime in ["reversible", "reversible"]:
    ...
    if regime=="reversible":
        ...
        k0_val=1
    params={"Cdl":{"Cdl":[1e-6, 1e-5, 1e-4],
                    "CdlE1":[-0.01, 0, 0.01],
                    "CdlE2":[-0.001, 0, 0.001]},
            "Ru":{"Ru":([100, 1000, 5000, 10000])}}
    unit_dict={
        "E_0": "V",
    ...
    def empty(arg):
        return arg
    plot_locs={"Cdl":{"Cdl":{"row":"row1", "col":0, "col_end":False, "func":e0_re_dim},
                    "CdlE1":{"row":"row2", "col":0, "col_end":False, "func":e0_re_dim},
                    "CdlE2":{"row":"row3", "col":0, "col_end":True, "func":e0_re_dim}},
            "Ru":{"Ru":{"row":"row2", "col":1, "col_end":True, "func":empty},
                    }}
